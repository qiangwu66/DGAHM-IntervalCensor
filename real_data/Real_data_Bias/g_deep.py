...
#%% --------------------------
def g_D(Z_train,X_train,U_train,V_train,De1_train,De2_train,De3_train,Z_val,X_val,U_val,V_val,De1_val,De2_val,De3_val,theta,C,m,nodevec,n_layer,n_node,n_lr,n_epoch):
