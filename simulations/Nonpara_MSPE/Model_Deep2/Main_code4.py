...
test_data = generate_case_4(500, corr, tau)
X_test = test_data['X']
...
def one_replication(b,
    ...
    train_data = generate_case_4(n, corr, tau)
    # valid data for early stopping/model selection
    valid_data = generate_case_4(valid_n, corr, tau)
...
result_MSPE.to_csv('MSPE_Case4.csv', index=False)
